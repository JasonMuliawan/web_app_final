...
export default function Rank(){
    ...
    return(
        <div>
        <img className="row-pic" src={require("./介紹排名.jpg")} alt="排行榜"/>
        <div className="four-container" id="你的排名">
            <div className="whitebox" id="div0" style={{backgroundImage: `url(${require('./background/暗餐具.jpg')})`}}>
            {/* <img src={require("./picture/查看排名.png")} alt="查看排名" id="img0" style={{width:'65%', margin:'auto'}}/> */}
            <h2 id="rank0" style={{marginTop:'20px'}}>第{rank["dish_rank"]}名</h2>
            ...
            {/* <img src={require("./picture/查看排名.png")} alt="查看排名" id="img1" style={{width:'65%', margin:'auto'}}/> */}
            <h2 id="rank1" style={{marginTop:'20px'}}>第{rank["plastic_rank"]}名</h2>
            ...
            {/* <img src={require("./picture/查看排名.png")} alt="查看排名" id="img2" style={{width:'65%', margin:'auto'}}/> */}
            <h2 id="rank2" style={{marginTop:'20px'}}>第{rank["meat_rank"]}名</h2>
            ...
            {/* <img src={require("./picture/查看排名.png")} alt="查看排名" id="img3" style={{width:'65%', margin:'auto'}}/> */}
            <h2 id="rank3" style={{marginTop:'20px'}}>第{rank["trans_rank"]}名</h2>
